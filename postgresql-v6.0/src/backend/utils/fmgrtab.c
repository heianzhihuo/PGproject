 ...
 *
 * IDENTIFICATION
 *    : /usr/local/cvsroot/postgres95/src/backend/utils/Gen_fmgrtab.sh,v 1.13 1997/01/24 17:59:58 scrappy Exp $
 *
 * NOTES
 *
 *	******************************
...
extern char *gistsel();
extern char *gistnpage();
extern char *gistgettuple();
extern char *gistinsert();
extern char *gistdelete();
extern char *gistbeginscan();
extern char *gistrescan();
extern char *gistendscan();
extern char *gistmarkpos();
extern char *gistrestrpos();
extern char *gistbuild();
...
extern char *date_larger();
extern char *date_smaller();
extern char *date_mi();
extern char *date_pli();
extern char *date_mii();
extern char *time_in();
...
static FmgrCall fmgr_builtins[] = {
  ...
  {772 , 7 , gistsel, "gistsel" },
  {773 , 7 , gistnpage, "gistnpage" },
  {774 , 2 , gistgettuple, "gistgettuple" },
  {775 , 5 , gistinsert, "gistinsert" },
  {776 , 2 , gistdelete, "gistdelete" },
  {777 , 4 , gistbeginscan, "gistbeginscan" },
  {778 , 3 , gistrescan, "gistrescan" },
  {779 , 1 , gistendscan, "gistendscan" },
  {780 , 1 , gistmarkpos, "gistmarkpos" },
  {781 , 1 , gistrestrpos, "gistrestrpos" },
  {782 , 9 , gistbuild, "gistbuild" },
  ...
  {1093 , 2 , date_larger, "date_larger" },
  {1094 , 2 , date_smaller, "date_smaller" },
  {1095 , 2 , date_mi, "date_mi" },
  {1096 , 2 , date_pli, "date_pli" },
  {1097 , 2 , date_mii, "date_mii" },
  ...
  {1242 , 1 , boolin, "boolin" },
  {1243 , 1 , boolout, "boolout" },
  {1244 , 1 , byteain, "byteain" },
  {1245 , 1 , charin, "charin" },
  {1246 , 2 , charlt, "charlt" },
  {1248 , 2 , charpl, "charpl" },
  {1250 , 2 , charmi, "charmi" },
  {1252 , 2 , nameregexne, "nameregexne" },
  {1254 , 2 , textregexeq, "textregexeq" },
  {1256 , 2 , textregexne, "textregexne" },
  {1258 , 2 , textcat, "textcat" },
  {1265 , 7 , rtsel, "rtsel" },
  {1266 , 7 , rtnpage, "rtnpage" },
  {1268 , 7 , btreesel, "btreesel" },
  {1270 , 7 , btreenpage, "btreenpage" },
  {1272 , 5 , eqsel, "eqsel" },
  {1274 , 2 , btchar16cmp, "btchar16cmp" },
  {1275 , 2 , char16eq, "char16eq" },
  {1276 , 2 , char16lt, "char16lt" },
  {1277 , 2 , char16le, "char16le" },
  {1278 , 2 , char16gt, "char16gt" },
  {1279 , 2 , char16ge, "char16ge" },
  {1280 , 2 , char16ne, "char16ne" },
  {1281 , 2 , hashchar16, "hashchar16" },
  {1285 , 2 , int4notin, "int4notin" },
  {1286 , 2 , oidnotin, "oidnotin" },
  {1287 , 1 , int44in, "int44in" },
  {1288 , 2 , char16regexeq, "char16regexeq" },
  {1289 , 2 , char16regexne, "char16regexne" },
  {1290 , 2 , char2icregexeq, "char2icregexeq" },
  {1291 , 2 , char2icregexne, "char2icregexne" },
  {1292 , 2 , char4icregexeq, "char4icregexeq" },
  {1293 , 2 , char4icregexne, "char4icregexne" },
  {1294 , 2 , char8icregexeq, "char8icregexeq" },
  {1295 , 2 , char8icregexne, "char8icregexne" },
	/* guardian value */
#ifndef WIN32
