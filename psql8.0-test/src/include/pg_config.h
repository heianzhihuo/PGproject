...
#define PACKAGE_STRING "PostgreSQL 8.0.0"
...
#define PG_VERSION_STR "PostgreSQL 8.0.0 on x86_64-unknown-linux-gnu, compiled by GCC gcc (Ubuntu 5.4.0-6ubuntu1~16.04.9) 5.4.0 20160609"
