 ...
 *
 * IDENTIFICATION
 *    $Header: /usr/local/cvsroot/postgres95/src/bin/pg_dump/pg_dump.c,v 1.22 1997/01/07 00:04:16 scrappy Exp $
 *
         ...
         TypeInfo *tinfo, int numTypes)
{
    ...
    for (i=0;i<numOperators;i++) {
        ...
        if (strcmp(oprinfo[i].oprrest, "-") == 0)
            ...
            sprintf(restrict_,", RESTRICT = %s ", oprinfo[i].oprrest);
