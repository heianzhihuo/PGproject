...
#line 2 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
/*-------------------------------------------------------------------------
 *
 * backendparse.y--
...
#line 43 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
#ifdef YYSTYPE
...
#line 292 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
...
Int_yyreduce:
    ...
    {
case 11:
#line 89 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{ 
		    DO_START;
...
break;
case 12:
#line 98 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{
		    DO_START;
...
break;
case 13:
#line 104 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{
		    DO_START;
		    closerel(NULL);
		    DO_END;
...
break;
case 14:
#line 113 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{ 
		    DO_START; 
		    numattr=(int)0;
		}
break;
case 15:
#line 118 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{ 
		    if (!Quiet) putchar('\n');
		    DO_END;
		}
break;
case 16:
#line 123 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{ 
		    DO_START; 
...
break;
case 17:
#line 166 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{ 
		    DO_START;
		    if (DebugMode)
...
break;
case 18:
#line 173 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{
...
break;
case 19:
#line 195 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{
		  List *params;
...
break;
case 20:
#line 210 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{ build_indices(); }
break;
case 21:
#line 214 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{
...
break;
case 22:
#line 222 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{
...
break;
case 23:
#line 228 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{
		    IndexElem *n = makeNode(IndexElem);
...
break;
case 24:
#line 237 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{
		  Int_yyval.list = lappend(NIL, makeString(LexIDStr(Int_yystack.l_mark[0].ival)));
		}
break;
case 25:
#line 241 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{
		  Int_yyval.list = lappend((List*)Int_yystack.l_mark[-2].list, makeString(LexIDStr(Int_yystack.l_mark[0].ival)));
		}
break;
case 26:
#line 246 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{ Int_yyval.ival = 1; }
break;
case 27:
#line 247 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{ Int_yyval.ival = 0; }
break;
case 30:
#line 257 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{ 
		   if(++numattr > MAXATTR)
...
break;
case 31:
#line 267 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{ Int_yyval.ival = atol(LexIDStr(Int_yystack.l_mark[0].ival)); 		}
break;
case 32:
#line 268 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{ extern Oid newoid(); Int_yyval.ival = newoid();	}
break;
case 36:
#line 278 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{InsertOneValue(objectid, LexIDStr(Int_yystack.l_mark[0].ival), num_tuples_read++); }
break;
case 37:
#line 279 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{InsertOneValue(objectid, LexIDStr(Int_yystack.l_mark[0].ival), num_tuples_read++); }
break;
case 38:
#line 281 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{ InsertOneNull(num_tuples_read++); }
break;
case 39:
#line 285 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{ Int_yyval.ival=Int_yylval.ival; }
break;
case 40:
#line 289 "/home/ubuntu/Postgresql/postgres95/src/backend/bootstrap/bootparse.y"
	{ Int_yyval.ival=Int_yylval.ival; }
break;
#line 759 "y.tab.c"
    }
